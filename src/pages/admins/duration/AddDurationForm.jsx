...
const AddDurationForm = () => {
    ...
    useEffect(() => {
        const fetchSport = async () => {
            try {
                const response = await axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/fetchSport');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/insertDuration', {
                durationName,
                durationDescription,
                sportID,
                numberOfSessions,
