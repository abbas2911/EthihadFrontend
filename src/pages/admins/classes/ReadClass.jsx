...
const ReadClass = () => {
    ...
    useEffect(() => {
        const fetchClassData = async () => {
            try {
                // Fetch class data
                const classResponse = await axios.get(`https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/read-class/${classID}`);
                ...
                // Fetch sport data
                const sportResponse = await axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/fetchSport');
                ...
                // Fetch term data
                const termResponse = await axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/fetchTerm');
                ...
                const ageCategoryResponse = await axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/classAgeCategory');
                ...
                // Fetch coach data
                const coachResponse = await axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/fetchCoach');
