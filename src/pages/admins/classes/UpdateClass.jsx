...
const UpdateClass = () => {
    ...
    useEffect(() => {
        const fetchClassData = async () => {
            try {
                const response = await axios.get(`https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/read-class/${classID}`);
        ...
        const fetchDropdownData = async () => {
            try {
                const [sportsResponse, termsResponse, locationsResponse, ageCategoriesResponse, coachesResponse] = await Promise.all([
                    ...
                    axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/classAgeCategory'),
                    axios.get('https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/fetchCoach')
                ]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (JSON.stringify(classItem) === JSON.stringify(originalClass)) {
            ...
            try {
                const response = await axios.put(`https://ethihad-backend-server-4565c742307a.herokuapp.com/api/admin/update-class/${classID}`, classItem);
